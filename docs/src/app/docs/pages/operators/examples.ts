export const UnaryOperatorExamples = [
    {
        ...
        codeSnippet: `let x = +"5";  // Converts '5' to a number (unary plus)
    ...
    },
    {
        ...
        codeSnippet: `let num = 5;    // Binary representation: 00000101
...
export const BinaryOperatorExamples = [
    {
        ...
        codeSnippet: `let a = 5 + 3;     // Addition
    ...
    },
    {
        ...
        codeSnippet: `let num1 = 5;        // Binary: 00000101
